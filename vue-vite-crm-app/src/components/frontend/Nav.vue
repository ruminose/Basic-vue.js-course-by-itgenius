<template>
    ...
    <header class="fixed w-full bg-white shadow-md" x-data="{menuOpen: false}">
        ...
        <nav class="container flex flex-wrap items-center px-4 mx-auto">
          <router-link to="/">
          <img src="@/assets/img/logo-main.webp" alt="logo" class="w-40" width="160" height="69" />
          </router-link>
            ...
            <div class="hidden w-full ml-auto lg:block lg:w-auto">
              ...
              หน้าหลัก 
               ...
               <router-link to="/about" class="block px-4 py-2 font-medium hover:text-indigo-900 lg:inline-block" >
              เกี่ยวกับเรา
              </router-link>

               <router-link to="/portfolio" class="block px-4 py-2 font-medium hover:text-indigo-900 lg:inline-block" >
              ผลงาน 
              </router-link>

               <router-link to="/service" class="block px-4 py-2 font-medium hover:text-indigo-900 lg:inline-block" >
              บริการ 
              </router-link>
